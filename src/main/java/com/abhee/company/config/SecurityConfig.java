...
public class SecurityConfig {
    ...
    // Constructor injection (explicit, no Lombok needed)
    public SecurityConfig(UserDetailsServiceApp userDetailsServiceApp, JwtRequestFilter jwtRequestFilter) {
    ...
    public AuthenticationManager authenticationManager() {
        ...
        authProvider.setUserDetailsService(userDetailsServiceApp);
